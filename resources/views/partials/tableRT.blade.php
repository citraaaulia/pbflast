...
<div class="max-w-[85rem] lg:py-1 mx-auto">
  ...
  <div class="px-6 py-1.5 flex justify-end">
    <button class="btn btn-primary" onclick="openForm()">Buat Disposisi</button>
      ...
      <div class="modal-content bg-white p-6 rounded-lg shadow-lg relative">
        ...
        <form action="{{ route('surat.store') }}" method="POST">
          ...
          <div class="mb-4">
            ...
            <textarea class="form-input mt-1 block w-full" id="pesan" name="pesan" rows="4" required></textarea>
          </div>
